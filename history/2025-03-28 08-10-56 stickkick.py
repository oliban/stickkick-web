...
while running:
    ...
    if match_over_timer > 0:
        ...
        if not match_end_sound_played and not game_over:
            ...
            play_next_announcement() # Trigger the first sound
    ...
    # Moved this call *after* event handling and state checks
    ...
    if goal_scored_this_frame:
        ...
        if winner_found_this_match:
            ...
            match_end_sound_played = False # Reset to allow sounds to be queued
