...
ROCKET_PLAYER_UPWARD_BOOST = 18.0 # <<< INCREASED VALUE
...
class ParachutePowerup: # Update returns active status
    def __init__(self):
...
while running:
    ...
    if match_active:
        ...
        for pup in active_powerups:
             pup.update(dt) # Call update on each powerup
    ...
    # --- Draw UI ---
    # ... (UI drawing unchanged, already handles multiple powerup display) ...
