...
DEBUG_BLUE = (0, 0, 255)
GOAL_COLOR = (220, 220, 220); GOAL_NET_COLOR = (180, 180, 190) # Original Colors restored
...
# Goal Constants
GOAL_MARGIN_X = 40 # <<< How far goals are from screen edge
GOAL_HEIGHT = 135; GOAL_POST_THICKNESS = 3; GOAL_Y_POS = GROUND_Y - GOAL_HEIGHT
GOAL_DEPTH_X = 30; GOAL_DEPTH_Y = -15
GOAL_LINE_X_LEFT = GOAL_MARGIN_X # <<< UPDATED Goal line X pos
GOAL_LINE_X_RIGHT = SCREEN_WIDTH - GOAL_MARGIN_X # <<< UPDATED Goal line X pos
...
def draw_goal_isometric(surface, goal_line_x, goal_y, goal_height, depth_x, depth_y, thickness, post_color, net_color):
    ...
    # Convert to integers right before drawing
