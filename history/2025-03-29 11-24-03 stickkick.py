...
while running:
    ...
    if match_over_timer > 0:
        ...
        # (This now happens only when winner_found_this_match is True below)
    ...
    # Removed the check from the main loop itself. Event handler does the work.
    # play_next_announcement() # <<< REMOVED THIS CALL FROM HERE
