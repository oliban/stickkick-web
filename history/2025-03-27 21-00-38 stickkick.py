...
# pygame.mixer.set_num_channels(16) # Optional
...
while running:
    ...
    if match_over_timer > 0:
        ...
        # --- Timer countdown and transition (Wait for queue) ---
        match_over_timer -= dt
    ...
    if announcement_queue and not announcement_channel.get_busy():
        ...
        if next_sound:
            print(f"Playing announcement: {next_sound}")
    ...
    if goal_scored_this_frame:
        ...
        if winner_found_this_match:
            ...
            match_end_sound_played = False # Reset to allow sounds for this match end
        ...
        if not winner_found_this_match: continue # Skip drawing this frame only if match continues
