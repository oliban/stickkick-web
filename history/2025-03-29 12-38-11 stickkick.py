...
# --- Helper Functions ---
# ... (draw_polygon_shape, draw_pentagon, draw_hexagon, normalize, draw_rotated_rectangle, draw_goal_isometric, draw_scoreboard, draw_game_scores, draw_trophy, draw_offscreen_arrow remain the same) ...
...
class StickMan: # Added wing attributes and logic
    def __init__(self, x, y, facing=1):
        ...
        # self.nose_randomize_timer = 0.0 # Removed timer
    ...
    def jump(self): # Conditional mid-air jump based on FLIGHT mode
        ...
        if can_jump_now:
            ...
            if flight_mode_active: self.start_wing_flap()
    def start_kick(self):
    ...
    def randomize_nose(self): # Randomizes nose at start of match
        ...
        # print(f"Player {1 if self.cap_color == (50,50,50) else 2} new nose factor: {random_factor:.2f}") # Optional Debug
    def update(self, dt, other_player): # Removed nose timer logic
    ...
    def draw(self, screen): # Updated head and wings
        ...
        nose_tip_y = head_center_y + self.head_radius * 0.1 # Adjusted Y slightly
...
while running:
    ...
    if goal_scored_this_frame:
        ...
        if winner_found_this_match:
            ...
            # Check overall game win AFTER queuing potential match sounds
