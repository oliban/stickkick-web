...
# --- Custom Event Types ---
SOUND_FINISHED_EVENT = pygame.USEREVENT + 1 # Keep this defined, even if not used in loop

# --- Helper Functions ---
# ... (draw_polygon_shape, etc... remain the same) ...
...
class StickMan: # Added wing attributes and logic
    ...
    def randomize_nose(self): # Randomizes nose at start of match
        ...
        # print(f"Player {1 if self.cap_color == (50,50,50) else 2} new nose factor: {random_factor:.2f}")
...
while running:
    ...
    # --- Process Announcement Sound Queue (Check every frame) ---
    play_next_announcement()
    ...
    if match_active:
        ...
        # ... (combo reset, player-ball collisions, combo trigger) ...
