...
def draw_goal_isometric(surface, goal_line_x, goal_y, goal_height, depth_x, depth_y, thickness, post_color, net_color):
    ...
    # If depth_x is -30 (left goal), back_x = goal_line_x - 30
    # If depth_x is +30 (right goal), back_x = goal_line_x + 30
    ...
    pygame.draw.line(surface, post_color, back_top, front_top, thickness)     # Top Bar (Connects Back to Front)
    pygame.draw.line(surface, post_color, back_bottom, front_bottom, thickness) # Bottom Bar (Connects Back to Front)
    pygame.draw.line(surface, post_color, front_top, front_bottom, thickness)   # Front Post

    # Draw simple net lines (crosses for perspective)
    pygame.draw.line(surface, net_color, front_top, back_bottom, 1) # Front top to back bottom
    pygame.draw.line(surface, net_color, front_bottom, back_top, 1) # Front bottom to back top
...
while running:
    ...
    # --- Draw Goals (Using restored function) ---
