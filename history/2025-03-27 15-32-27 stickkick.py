...
ARROW_RED = (:** Replace the simple `draw_goal` with a function that draws lines connecting front and back points.
**3. Update Drawing Call:** Use the new function in the main loop.
**4. Adjust Goal Detection:** Use specific X-coordinates for the goal lines.

Here's the updated `stickkick.py`:
...
ITALY_GREEN = (0, 146, 70); ITALY_WHITE = (241, 242, 241); ITALY_RED = (206, 43, 55)
GRASS_GREEN = (34, 139, 34); YELLOW = (255, 255, 0); TEXT_COLOR = (10, 10, 50)
ARROW_RED = (255, 50, 50);255, 50, 50); STAR_YELLOW = (255, 255, 100); STAR_ORANGE = (255, 180, 0)
