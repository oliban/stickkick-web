...
# --- Sound Loading ---
# ... (load_sounds function remains the same as previous version) ...
...
while running:
    ...
    # This happens every frame, but only proceeds if the channel is free
    ...
    if goal_scored_this_frame:
        ...
        if winner_found_this_match:
            ...
            # Update game score BEFORE queuing sounds
