...
class StickMan: #...
    ...
    def stop_move(self): # ... (as before) ...
        self.vx = 0
    def jump(self): # ... (Added sound trigger) ...
...
while running:
    ...
    # --- Drawing --- (as before)
    screen.fill(SKY_BLUE); pygame.draw.rect(screen, GRASS_GREEN, (0, GROUND_Y, SCREEN_WIDTH, SCREEN_HEIGHT - GROUND_Y)) # ... (rest of drawing as before) ...
